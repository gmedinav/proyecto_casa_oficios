  ...
  <div class="content-wrapper">
   ...
   <table width="750px">
      <tr>
        ...
        <td ><input type="text" value="<?php echo $data['COD_SOLICITUD']; ?>"></td>
        <td width="20%"> </td>     
        <td><strong>Cliente:</strong></td>     
        <td><input type="text" value="<?php echo $data['NOMBRE']; ?>" /></td>   
      </tr>

      <tr>
        <td><strong>Tipo Avería:</strong></td>        
        <td><input type="text" value="<?php echo $data['DES_TIPO_AVERIA']; ?>"/></td>
        <td> </td>     
        <td><strong>Distrito:</strong></td>     
        <td><input type="text" value="<?php echo $data['DES_UBIGEO']; ?>"/></td>           
      </tr>

      <tr>
        <td><strong>Descripción:</strong></td>        
        <td><textarea><?php echo $data['DESCRIPCION']; ?></textarea></td>
        <td> </td>     
