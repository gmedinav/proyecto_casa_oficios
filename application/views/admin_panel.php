  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="<?php echo base_url()."assets/admin_panel/";?>#"><i class="fa fa-id-card-o"></i> <span>Gestión Laboral</span>
        ...
        <li class="treeview">
          <a href="<?php echo base_url()."assets/admin_panel/";?>#"><i class="glyphicon glyphicon-briefcase"></i> <span>Gestión Sistema </span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="<?php echo base_url()."assets/admin_panel/";?>#"><i class="fa fa-database"></i> <span>Info Preestablecida </span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
