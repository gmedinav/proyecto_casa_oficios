        ...
        <div class="container">
           <div class="wow fadeInDown" >
                ...
                <div class="col-sm-7">
                    ...
                    <h1 style="color:black;">Acerca de nosotros</h1><br>
                    <p  class="lead" style="color:black;">
                    
                    Somos una empresa jove, ubicada en Lima, Perú.<br>
                    
                       <li><strong>Misión</strong></li>
                        Facilitar la solución de una urgencia ante un percance en el hogar, a través las oportunidad laboral para personal no profesional<br><br>


                        <li><strong>Visión</strong></li>
                        Ser la empresa líder en empleabilidad laboral no profesional. <br><br>
                        
                        
 

                        <li><strong>Objetivo</strong></li>
                        Cubrir inicialmente el servio a nivel Lima. <br><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <a target="_blank" href="http://www.dectersoluciones.com/" title="Decter Soluciones">Decter Soluciones</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
                        <li><a href="<?php echo base_url('solicitar_trabajo'); ?>">Inicio</a></li>
